...
const STOCKS: StockPrice[] = [
  ...
  },
  {
    ...
    name: "SEB A",
    currency: "SEK",
    regularMarketPrice: 154.8,
    regularMarketChange: -0.93,
    regularMarketChangePercent: -0.6,
    regularMarketVolume: 2_140_000,
    averageDailyVolume3Month: 2_800_000,
    fiftyTwoWeekHigh: 168.0,
    fiftyTwoWeekLow: 132.5,
    marketState: "CLOSED",
  },
  {
    ticker: "ATCO-A.ST",
...
const ANALYSIS: StockAnalysis[] = [
  ...
  },
  {
    ...
    rating: "⚠️ TURBULENCE",
    sentiment: "neutral",
    comment: "Swedish banking sideways, neither tendies nor pain",
  },
  {
    ticker: "ATCO-A.ST",
    rating: "💎 DIAMOND HANDS",
